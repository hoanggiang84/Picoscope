...
namespace SAM.Picoscope
{
    public class MicroTimer
    {
        ...
        public void Start()
        {
            ...
            System.Threading.ThreadStart threadStart = () => NotificationTimer(ref _timerIntervalInMicroSec,
                                                                               ref _ignoreEventIfLateBy,
                                                                               ref _stopTimer);

            _threadTimer = new System.Threading.Thread(threadStart) {Priority = System.Threading.ThreadPriority.Highest};
            _threadTimer.Start();
        }
